...
//
// Monterey compatibility does not use the screencapturekit Swift bridge, so
// the macOS binary needs only the active SDK framework search path and has no
// Swift compiler/runtime requirement.
